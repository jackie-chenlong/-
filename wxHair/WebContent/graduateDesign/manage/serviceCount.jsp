...
<![endif]-->
        ...
        <script src="graduateDesign/js/highcharts.js"></script>
			...
			//请求商店订单数据
			var ajaxObj =  $.ajax({
				url: "ordersController/getServiceNum.action",
				type: "post",
				dataType:'json',
				data: "",
				success: function(res){
					...
					if(res){
						for(var i=0;i<res.length;i++){
						   nameArr.push(res[i].service);
						   orderNumArr.push(res[i].orderNum);
						   var obj = {};
						   obj.name = res[i].service;
						   obj.y = res[i].orderNum;
						   pieData.push(obj);
						}
