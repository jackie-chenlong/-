				...
				<ul class="nav nav-list">
                    ...
                    <li class="">
						...
						<ul class="submenu">
							...
							<li class="">
								<a href="graduateDesign/manage/service.jsp">
									<i class="menu-icon fa fa-caret-right"></i>
									服务统计
								</a>
		  ...
		  var grid_data;
			...
			jQuery(function($) {
				...
				*/
				...
				//请求所有用户数据	
				var ajaxObj =  $.ajax({
					url: "ordersController/getAllOrders.action",
					type: "post",
					dataType:'json',
					data: "",
					success: function(res){	
						if(res){
							...
							jQuery(grid_selector).jqGrid({
								...
								datatype: "local",
								height: 350,
								colNames:[' ', 'ID','User_id','Shop_id','Service','Stylist','Price','Time','Stat'],
								colModel:[
									...
									{name:'user_id',index:'user_id', width:100,editable: true,editoptions:{size:"20",maxlength:"30"}},
									{name:'shop_id',index:'shop_id', width:100, sortable:true,editable: true,editoptions:{rows:"2",cols:"10"}},
									{name:'service',index:'service', width:130, editable: true},
									{name:'stylist',index:'stylist', width:130, editable: true},
									{name:'price',index:'price', width:130, editable: true},
									{name:'time',index:'time', width:130, editable: true},
									{name:'stat',index:'stat', width:130, editable: true}
								], 
