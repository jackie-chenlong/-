					...
					success: function(res){	
						if(res){
							...
							jQuery(grid_selector).jqGrid({
								...
								datatype: "local",
								height: 350,
								colNames:[' ', 'ID','Name','Address','Password'],
								colModel:[
									...
									{name:'id',index:'id', width:160, sorttype:"int", editable: true},
									
									{name:'name',index:'name', width:300,editable: true,editoptions:{size:"20",maxlength:"30"}},
									{name:'address',index:'address', width:300, sortable:true,editable: true, editoptions:{rows:"2",cols:"10"}},
									{name:'password',index:'password', width:300, sortable:true,editable: true}
								], 
